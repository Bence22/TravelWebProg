...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2023. Nov 24. 15:29
...
CREATE TABLE `comments` (
  ...
  `szalloda_az` varchar(2) DEFAULT NULL
...
INSERT INTO `comments` (`cid`, `uid`, `username`, `comment`, `created`, `szalloda_az`) VALUES
(1, 1, 'KissJakab', 'Isteni volt Srácok!!!', '2023-11-19 21:34:46', 'BS'),
(2, 1, 'KissJakab', 'Tökéletes', '2023-11-19 21:40:16', 'BS'),
(3, 2, 'Nagy Timi', 'Legjobb hely!', '2023-11-20 13:14:20', 'FJ');
...
CREATE TABLE `szalloda` (
  `az` char(2) NOT NULL,
  `nev` varchar(255) DEFAULT NULL,
  `besorolas` int(11) DEFAULT NULL,
  `helyseg_az` int(11) DEFAULT NULL,
  `tengerpart_tav` int(11) DEFAULT NULL,
  `repter_tav` int(11) DEFAULT NULL,
  `felpanzio` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(1, 'kissjakab@gmail.com', 'KissJakab', '$2y$10$tGm7tn.wHdcrlHO33NZKOOZGYJUX58t8SDaY8TWM.DX6mH4KJDqKO'),
(2, 'nagytimi@gmail.com', 'Nagy Timi', '$2y$10$kcOynjan.vCz26s1kJ18Du2wAiiIzu1sgUqiXatUnZBhUxb0anpTC');
...
ALTER TABLE `szalloda`
  ADD PRIMARY KEY (`az`),
  ADD KEY `fk_szalloda_helyseg` (`helyseg_az`);
...
ALTER TABLE `tavasz`
  ...
  ADD KEY `fk_tavasz_szalloda` (`szalloda_az`);
...
--
ALTER TABLE `szalloda`
  ADD CONSTRAINT `fk_szalloda_helyseg` FOREIGN KEY (`helyseg_az`) REFERENCES `helyseg` (`az`);

--
-- Megkötések a táblához `tavasz`
--
ALTER TABLE `tavasz`
  ADD CONSTRAINT `fk_tavasz_szalloda` FOREIGN KEY (`szalloda_az`) REFERENCES `szalloda` (`az`);
COMMIT;
